...
1. The filtered section text used by the psych-history classifier:
   ../01_classification_psych_integrated/psych_history_llm_input/
       filtered_psych_keyword_section_input.parquet

2. The section-level psych-history LLM output:
   ../01_classification_psych_integrated/psych_history_classifier_output/
...
PSYCH_HISTORY_DIR = SCRIPT_DIR.parent / "01_classification_psych_integrated"
INPUT_PATH = Path(
    os.environ.get(
