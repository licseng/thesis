...
KEYWORD_PATTERN_LABELS = {
    ...
    r"\bclaiming\b": "claim",
    r"\bclaims\b": "claim",
    r"\binconsistent\s+historian\b": "inconsistent historian",
    r"\binsist\b": "insist",
    ...
    r"\breportedly\b": "reportedly",
    r"\bsupposedly\b": "supposedly",
    r"\bunreliable\s+historian\b": "unreliable historian",
